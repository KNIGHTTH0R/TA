<header class="p-2 bg-coolGray-50 text-coolGray-800">
    <div class="px-6 container flex justify-between h-16 mx-auto">
        <div class="flex">
            <a href="/" aria-label="Back to homepage" class="flex items-center p-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-10 h-10 text-sky-600">
        ...
        <div class="items-center flex-shrink-0 hidden md:flex space-x-3">
            <button class="px-6 py-3 font-semibold border rounded border-coolGray-800 hover:border-transparent hover:bg-sky-600 hover:text-coolGray-50 transition ease-in-out duration-500">Daftar</button>
            <button class="px-6 py-3 font-semibold rounded bg-sky-600 text-coolGray-50">Masuk</button>
        </div>
