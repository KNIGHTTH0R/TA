<div class="flex justify-center px-4 col-span-full md:col-span-1 md:flex-col md:justify-start md:items-start border-coolGray-300">
    ...
    <a href="{{ route('auth.dashboard.history') }}" class="px-2 py-1 border-b-2 md:border-l-2 md:border-b-0 md:py-3 @if(request()->route()->getName() == 'auth.dashboard.history') border-violet-800 @endif text-coolGray-900">Riwayat donasi</a>
    <a href="{{ route('auth.profile.show') }}" class="px-2 py-1 border-b-2 md:border-l-2 md:border-b-0 md:py-3 @if(request()->route()->getName() == 'auth.profile.show') border-violet-800 @endif text-coolGray-600">Edit profile</a>
     <a href="{{ route('auth.password.show') }}" class="px-2 py-1 border-b-2 md:border-l-2 md:border-b-0 md:py-3 @if(request()->route()->getName() == 'auth.password.show') border-violet-800 @endif text-coolGray-600">Ubah password</a>
